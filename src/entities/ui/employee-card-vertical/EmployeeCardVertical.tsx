...
import classes from "./EmployeeCardVertical.module.scss"
...
const EmployeeCardVertical: React.FC<Props> = ({ onClick, name, surname, lastname, birthday, filial, jobTitle, image, data }) => {
  return (
...
export default EmployeeCardVertical;
